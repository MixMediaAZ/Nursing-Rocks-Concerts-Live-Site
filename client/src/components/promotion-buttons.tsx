        ...
        <div className="flex flex-col sm:flex-row justify-center items-start gap-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <Button 
              ...
              className="flex items-center gap-2 bg-[#F61D7A] hover:bg-[#E01060] text-white px-8 py-6 rounded-lg text-lg font-semibold transition-transform hover:scale-105 shadow-md w-full"
            >
          ...
          <div className="flex flex-col items-center">
            ...
            <Button 
              ...
              className="flex items-center gap-2 bg-[#00A3E0] hover:bg-[#0089BE] text-white px-8 py-6 rounded-lg text-lg font-semibold transition-transform hover:scale-105 shadow-md w-full"
            >
