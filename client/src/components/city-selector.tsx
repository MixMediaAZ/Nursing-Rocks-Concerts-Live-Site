...
// Direct paths to the city background image files in public folder
// Each image has been selected to best represent the city
const chicagoImage = "/public/assets/city_backgrounds/6AEA04AA-A9A3-4F6E-9C15-CCAFE3BC50F8.PNG"; // Chicago skyline
const washingtonImage = "/public/assets/city_backgrounds/6D6FD547-7B8E-4871-B7D1-8CD2BDD76E98.PNG"; // Washington DC monuments
const sanFranciscoImage = "/public/assets/city_backgrounds/FF6856D4-8B81-49FE-BB14-D4E99A44F9B6.PNG"; // San Francisco Golden Gate
const bostonImage = "/public/assets/city_backgrounds/3B39719F-9D81-4397-9EFB-74CA91F16E2C.PNG"; // Boston cityscape
const newYorkImage = "/public/assets/city_backgrounds/9AF7FDEB-8BB4-4BCE-9E9F-560BCABE7572.PNG"; // NYC skyline
const houstonImage = "/public/assets/city_backgrounds/CA566C49-0E82-4288-9CF4-328CD8F61EC6.PNG"; // Houston 
const denverImage = "/public/assets/city_backgrounds/4A5B3B48-E885-44BF-9FD2-93927C35FDC8.PNG"; // Denver mountains
const atlantaImage = "/public/assets/city_backgrounds/3B80F8ED-69E6-4337-BEBC-12A3402C5653.PNG"; // Atlanta
const losAngelesImage = "/public/assets/city_backgrounds/1DFDF38A-CC77-42B3-803D-336853030512.PNG"; // LA skyline - example
const nashvilleImage = "/public/assets/city_backgrounds/E236F46B-0F0C-4BBF-936D-7F1918647585.PNG"; // Nashville music scene
const dallasImage = "/public/assets/city_backgrounds/2CA4A9EC-7F93-43A0-A9E2-1834A4BA1A84.PNG"; // Dallas cityscape
