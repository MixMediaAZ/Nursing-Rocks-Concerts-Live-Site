    ...
    <>
      <div className="bg-gradient-to-r from-[#5D3FD3]/90 to-[#FF3366]/90 text-white">
        <div className="container mx-auto px-6 md:px-8 py-12">
          <div className="flex flex-col md:flex-row md:items-center md:justify-center text-center md:text-center">
            <div>
      ...
      <div className="container mx-auto px-6 md:px-8 py-12">
        <div className="max-w-6xl mx-auto bg-white p-4 md:p-6 rounded-lg shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <img 
                src={event.image_url || ''} 
